...
{
    // Lightweight LocalDbContext used by the MAUI client for SQLite storage.
    public class LocalDbContext : DbContext
    {
        ...
        {
            // Intentionally empty: runtime configuration is provided by DI in the MAUI app.
        }
        ...
        // Minimal repair/seed used by MAUI client if needed
